...
namespace Dependinator.Utils.UI.VirtualCanvas
{
    ...
    public sealed class ArithmeticConverter : IValueConverter, IMultiValueConverter
    {
        ...
        /// </summary>
        /// <param name="values">
        ///     Input values that are convertable via
        ///     <see cref="System.Convert.ToDouble" />.
        /// </param>
        /// <param name="targetType">Ignored; the target type is always <see cref="Double" />.</param>
        /// <param name="parameter">
        ///     The binary arithmetic operator(s) to apply to the values.
        ///     Supported operators are +, -, *, /, %, and ^.  The number of operators must be exactly one
        ///     fewer than the number of values.
        /// </param>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        ///     A <see cref="Double" /> that is the result of transitively applying the operations
        ///     in the <paramref name="parameter" /> to the <paramref name="values" />.
        /// </returns>
        ...
        /// </summary>
        /// <param name="value">
        ///     Input value that is convertable via
        ///     <see cref="System.Convert.ToDouble" />.
        /// </param>
        /// <param name="targetType">Ignored; the target type is always <see cref="Double" />.</param>
        /// <param name="parameter">
        ///     The unary arithmetic operator(s) to apply to the value.  Supported
        ///     operators are + (Math.Abs) and - (Negate).
        /// </param>
        /// <param name="culture">
        ///     An <see cref="IFormatProvider" /> interface implementation that
        ///     supplies culture-specific formatting information.
        ...
        /// <returns>
        ///     A <see cref="Double" /> that is the result of transitively applying the operations
        ///     in the <paramref name="parameter" /> to the <paramref name="value" />.
        /// </returns>
        ...
        /// <returns>
        ///     The result of applying the <paramref name="operation" /> to the
