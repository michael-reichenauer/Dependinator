...
namespace Dependinator.Utils.UI.VirtualCanvas
{
    ...
    public static class LinkedListExtensions
    {
        ...
        /// <param name="node">
        ///     The node after which to search for the value in the linked list, or
        ///     <c>null</c> to search from the beginning.
        /// </param>
        /// <param name="value">The value to locate in the linked list.</param>
        /// <returns>
        ///     The first node after the given node that contains the specified value, if
        ...
        /// <param name="list">The linked list.</param>
        /// <param name="node">
        ///     The node before which to search for the value in the linked list,
        ///     or <c>null</c> to search from the end.
        /// </param>
        /// <param name="value">The value to locate in the linked list.</param>
        /// <returns>
        ///     The first node before the given node that contains the specified value, if
        ///     found; otherwise, <c>null</c>.
        /// </returns>
