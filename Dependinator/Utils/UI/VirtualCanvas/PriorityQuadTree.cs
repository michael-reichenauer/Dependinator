    ...
    public class PriorityQuadTree<T> : IEnumerable<T>
    {
        ...
        private class QuadNode
        {
            ...
            public IEnumerable<Tuple<QuadNode, double>> GetNodesIntersecting(Rect bounds)
            {
                ...
                } while (!ReferenceEquals(n.Node, Node));
            }
        ...
        private class Quadrant : IEnumerable<QuadNode>
        {
            ...
            private double
                _potential = double.NegativeInfinity; // the maximum priority of all nodes within this quadrant.
            ...
            internal bool Remove(T node, Rect bounds)
            {
                ...
                else
                {
                    ...
                    else if (_bottomRight != null && bottomRight.Intersects(bounds) &&
                             _bottomRight.Remove(node, bounds))
                    {
