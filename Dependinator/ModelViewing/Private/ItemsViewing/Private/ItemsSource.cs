...
namespace Dependinator.ModelViewing.Private.ItemsViewing.Private
{
    ...
    {
        private static readonly TimeSpan ItemsChangedInterval = TimeSpan.FromMilliseconds(300);
        private static readonly TimeSpan ExtentChangedInterval = TimeSpan.FromMilliseconds(300);
