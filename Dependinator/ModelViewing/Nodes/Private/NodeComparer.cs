...
namespace Dependinator.ModelViewing.Nodes.Private
{
	internal static class NodeComparer
	{
		...
		private static int CompareNodes(Node parent, Node e1, Node e2)
		{
			...
			int e1ToE2Count = e1ToE2?.LinkCount2 ?? 0;
			int e2ToE1Count = e2ToE1?.LinkCount2 ?? 0;
			...
			int parentToE1Count = parentToE1?.LinkCount2 ?? 0;
			int parentToE2Count = parentToE2?.LinkCount2 ?? 0;
			...
			int e1ToParentCount = e1ToParent?.LinkCount2 ?? 0;
			int e2ToParentCount = e2ToParent?.LinkCount2 ?? 0;
