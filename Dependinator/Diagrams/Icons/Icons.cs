...
static class Icon
{
    ...
    static readonly string ConstructorIcon = """
        <svg id="ConstructorIcon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><defs><radialGradient id="constructorGradient" cx="55.71" cy="71.92" r="9" gradientTransform="translate(-43.61 -58.92) scale(0.94 0.94)" gradientUnits="userSpaceOnUse"><stop offset="0.67" stop-color="#6bb9f2" /><stop offset="0.74" stop-color="#61b4f1" /><stop offset="0.85" stop-color="#47a8ef" /><stop offset="0.99" stop-color="#1d94eb" /><stop offset="1" stop-color="#1b93eb" /></radialGradient></defs><path d="M9,.5A8.5,8.5,0,1,0,17.5,9,8.5,8.5,0,0,0,9,.5Z" fill="url(#constructorGradient)" /><circle cx="9" cy="9" r="7.03" fill="#fff" /><rect x="5.9" y="5.9" width="6.2" height="6.2" rx="1.3" fill="#32bedd" /><path d="M8.9,7.4V9H7.4v1.4H8.9v1.6h1.4V10.4h1.6V9H10.3V7.4Z" fill="#fff" /></svg>
        """;
