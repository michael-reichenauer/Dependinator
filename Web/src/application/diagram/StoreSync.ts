...
//       sync = this.local.updateSync({
//         token: connectData.token,
//         provider: connectData.provider,
//         details: connectData.details,
//       });
...
//     if (
//       before.diagramId === after.diagramId &&
...
//   async newDiagram(diagram: DiagramDto): Promise<void> {
//     if (!this.isSyncEnabled) {
//       return;
//     }
...
//       .catch((_) => setErrorMessage("Failed to sync canvas change"));
//   }
...
//     this.api
//       .updateDiagram({ diagramInfo: { diagramId: diagramId, name: name } })
//       .then((diagramInfo) => this.local.writeDiagramInfo(diagramInfo))
//       .catch((_) => setErrorMessage("Failed to sync name change"));
//   }

//   async uploadDiagrams(diagrams: DiagramDto[]) {
//     if (!this.isSyncEnabled) {
//       return false;
//     }
...
//       return true;
//     } catch (error) {
//       setErrorMessage("Failed to clear remote data, " + error);
//       return false;
//     } finally {
//       setProgress(false);
//     }
...
//       const localInfo = localInfos.find(
//         (l) => l.diagramId === remoteInfo.diagramId
//       );
//       if (!localInfo) {
...
//         (r: any) => r.diagramId === localInfo.diagramId
//       );
//       if (!remoteInfo) {
