...
// Exercises the manual "design" flow through the browser: double-click empty canvas to add a
// user-drawn node, that it survives a reload (persisted with IsManual), and that only manual
// nodes expose the Delete action. Editing is enabled by default in the Blazor Server host.
